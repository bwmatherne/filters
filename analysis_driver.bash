...
qsub code/seq.pbs
#########################################################
#2 Combine the three output tables

qsub code/combine_table.pbs


# Archive all sequencing files and move to the data/process/ folder
tar -zcvf data/process/seq1.tar.gz data/qiime/seq1/
rm -rf data/qiime/seq1/
tar -zcvf data/process/seq2.tar.gz data/qiime/seq2/
rm -rf data/qiime/seq2/
tar -zcvf data/process/seq3.tar.gz data/qiime/seq3/
rm -rf data/qiime/seq3/
tar -zcvf data/process/seq4.tar.gz data/qiime/seq4/
rm -rf data/qiime/seq4/
...
########################################################
#5 Export BIOM File for R stats

bash code/export.bash


########################################################
#6 Collapse Taxonomic Data

qsub code/taxa.pbs

########################################################
#7 Convert Biom file to tsv

bash code/biom_convert.bash

########################################################
#8 Download and analyze your data in R
